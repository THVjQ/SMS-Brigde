...
See [`README-Files/2_INSTALLATION_GUIDE.md`](sms-bridge/README-Files/2_INSTALLATION_GUIDE.md) for full setup instructions, or [`sms-bridge/docker-compose.truenas.yml`](sms-bridge/docker-compose.truenas.yml) for a TrueNAS SCALE Custom App deployment.

**Short version:**

```bash
# 1. Start the server
cd sms-bridge/sospos-tools
npm install
...
For a container deployment see [`sms-bridge/docker-compose.truenas.yml`](sms-bridge/docker-compose.truenas.yml) and its `.env.example`. Upgrading is `docker compose pull && docker compose up -d` — a plain restart reuses the cached image and silently keeps running the old build.
...
| File | Contents |
|------|----------|
| [`README-Files/1_SYSTEM_DOCUMENTATION.md`](sms-bridge/README-Files/1_SYSTEM_DOCUMENTATION.md) | Full technical breakdown — architecture, encryption, API reference, data flow |
| [`README-Files/2_INSTALLATION_GUIDE.md`](sms-bridge/README-Files/2_INSTALLATION_GUIDE.md) | Step-by-step setup for server, extension, and APK |
| [`README-Files/3_APP_USER_GUIDE.md`](sms-bridge/README-Files/3_APP_USER_GUIDE.md) | Android app user guide |
| [`README-Files/4_EXTENSION_USER_GUIDE.md`](sms-bridge/README-Files/4_EXTENSION_USER_GUIDE.md) | Chrome extension user guide |
